# PYTHONPATH='.' AWS_PROFILE=educate1 luigi --module alter_orq GetFEData --local-scheduler
...
class GetFEData(luigi.Task):
    ...
    def requires(self):
        return GetCleanData(), GetCleanDataSet(), GetDataSet(), downloadDataS3()
